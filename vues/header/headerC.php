<?php  ob_start(); ?>
	<img class="avatar_header" src="<?= $_SESSION['avatar'] ?>"</img>
		<aside>
			...
			<a class="bouton_profil" href="creation.php"><img class="mini_icone" src="<?php $_SERVER['DOCUMENT_ROOT']?>/SITEBOUSILLE/img/icone/university.png"></img> Poster une Connaissance</a>	<br/>
			<a class="bouton_profil" href="#"><img class="mini_icone" src="<?php $_SERVER['DOCUMENT_ROOT']?>/SITEBOUSILLE/img/icone/paper-airplane.png"></img> Poster une Annonce</a><br/>
